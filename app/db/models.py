...
class VisualPromptPackage(Base):
    ...
    mascot_overlay: Mapped[str] = mapped_column(Text, nullable=False, default="{}")
    activation_status: Mapped[str] = mapped_column(String(16), nullable=False, default="CANDIDATE")
    runtime_selectable: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False)
...
class CharacterReferenceCandidate(Base):
    __tablename__ = "character_reference_candidates"
    id: Mapped[str] = mapped_column(String(36), primary_key=True)
    character_bible_id: Mapped[str] = mapped_column(ForeignKey("character_bibles.id"), nullable=False)
    character_id: Mapped[str] = mapped_column(String(120), nullable=False)
    character_bible_version: Mapped[int] = mapped_column(Integer, nullable=False)
    bible_set_id: Mapped[str] = mapped_column(ForeignKey("visual_bible_sets.id"), nullable=False)
    bible_set_version: Mapped[int] = mapped_column(Integer, nullable=False)
    base_model_id: Mapped[str] = mapped_column(String(160), nullable=False)
    base_model_revision: Mapped[str] = mapped_column(String(80), nullable=False)
    base_model_sha256: Mapped[str] = mapped_column(String(64), nullable=False)
    positive_prompt: Mapped[str] = mapped_column(Text, nullable=False)
    negative_prompt: Mapped[str] = mapped_column(Text, nullable=False)
    ...
    sampler: Mapped[str] = mapped_column(String(40), nullable=False)
    ...
    comfyui_revision: Mapped[str] = mapped_column(String(80), nullable=False)
    latency_ms: Mapped[int] = mapped_column(Integer, nullable=False)
    vram_before: Mapped[str] = mapped_column(Text, nullable=False)
    vram_peak: Mapped[str] = mapped_column(Text, nullable=False)
    vram_after: Mapped[str] = mapped_column(Text, nullable=False)
    governance_status: Mapped[str] = mapped_column(String(16), nullable=False, default="DRAFT")
    human_review_status: Mapped[str] = mapped_column(String(24), nullable=False, default="PENDING")
    reference_status: Mapped[str] = mapped_column(String(24), nullable=False, default="CANDIDATE")
    release_eligible: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False)
    lora_status: Mapped[str] = mapped_column(String(24), nullable=False, default="NOT_ASSIGNED")
    created_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), server_default=func.now(), nullable=False)


class MascotAsset(Base):
    __tablename__ = "mascot_assets"
    id: Mapped[str] = mapped_column(String(36), primary_key=True)
    mascot_bible_id: Mapped[str] = mapped_column(ForeignKey("mascot_character_bibles.id", ondelete="CASCADE"), nullable=False)
    canonical_filename: Mapped[str] = mapped_column(String(160), nullable=False)
    source_relative_path: Mapped[str] = mapped_column(Text, nullable=False)
    sha256: Mapped[str] = mapped_column(String(64), nullable=False, unique=True)
    mime_type: Mapped[str] = mapped_column(String(80), nullable=False)
    magic_valid: Mapped[bool] = mapped_column(Boolean, nullable=False)
    width: Mapped[int] = mapped_column(Integer, nullable=False)
    height: Mapped[int] = mapped_column(Integer, nullable=False)
    color_mode: Mapped[str] = mapped_column(String(24), nullable=False)
    alpha_present: Mapped[bool] = mapped_column(Boolean, nullable=False)
    expression_label: Mapped[str] = mapped_column(String(80), nullable=False)
    props_json: Mapped[str] = mapped_column(Text, nullable=False, default="[]")
    prop_contamination: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False)
    source_provenance: Mapped[str] = mapped_column(Text, nullable=False)
    creation_tool: Mapped[str] = mapped_column(String(160), nullable=False)
    ownership_declaration: Mapped[str] = mapped_column(Text, nullable=False)
    reference_permission: Mapped[str] = mapped_column(String(32), nullable=False)
    training_permission: Mapped[str] = mapped_column(String(32), nullable=False)
    review_status: Mapped[str] = mapped_column(String(24), nullable=False, default="PENDING")
    created_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), server_default=func.now(), nullable=False)


class MascotCharacterBible(Base):
    __tablename__ = "mascot_character_bibles"
    id: Mapped[str] = mapped_column(String(36), primary_key=True)
    bible_set_id: Mapped[str] = mapped_column(ForeignKey("visual_bible_sets.id", ondelete="CASCADE"), nullable=False)
    provisional_name: Mapped[str] = mapped_column(String(80), nullable=False)
    character_type: Mapped[str] = mapped_column(String(80), nullable=False)
    role: Mapped[str] = mapped_column(String(160), nullable=False)
    runtime_presentation: Mapped[str] = mapped_column(String(80), nullable=False)
    recurring: Mapped[bool] = mapped_column(Boolean, nullable=False)
    student_identity: Mapped[bool] = mapped_column(Boolean, nullable=False)
    teacher_identity: Mapped[bool] = mapped_column(Boolean, nullable=False)
    cultural_claim: Mapped[str] = mapped_column(String(32), nullable=False)
    school_uniform: Mapped[str] = mapped_column(String(32), nullable=False)
    red_scarf: Mapped[str] = mapped_column(String(32), nullable=False)
    style: Mapped[str] = mapped_column(Text, nullable=False)
    identity_constraints: Mapped[str] = mapped_column(Text, nullable=False)
    governance_status: Mapped[str] = mapped_column(String(16), nullable=False, default="DRAFT")
    release_eligible: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False)
    review_status: Mapped[str] = mapped_column(String(24), nullable=False, default="PENDING")
    created_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), server_default=func.now(), nullable=False)
...
class MascotSceneBinding(Base):
    __tablename__ = "mascot_scene_bindings"
    id: Mapped[str] = mapped_column(String(36), primary_key=True)
    bible_set_id: Mapped[str] = mapped_column(ForeignKey("visual_bible_sets.id", ondelete="CASCADE"), nullable=False)
    scene_id: Mapped[str] = mapped_column(String(120), nullable=False)
    mascot_bible_id: Mapped[str] = mapped_column(ForeignKey("mascot_character_bibles.id"), nullable=False)
    asset_id: Mapped[str] = mapped_column(ForeignKey("mascot_assets.id"), nullable=False)
    expression: Mapped[str] = mapped_column(String(80), nullable=False)
    role: Mapped[str] = mapped_column(String(80), nullable=False)
    preferred_anchor: Mapped[str] = mapped_column(String(32), nullable=False)
    max_frame_height_ratio: Mapped[float] = mapped_column(Float, nullable=False, default=0.22)
    subtitle_safe_bottom_ratio: Mapped[float] = mapped_column(Float, nullable=False, default=0.18)
    entrance: Mapped[str] = mapped_column(String(80), nullable=False)
    exit: Mapped[str] = mapped_column(String(80), nullable=False)
    motion_hint: Mapped[str] = mapped_column(String(120), nullable=False)
    alpha_required: Mapped[bool] = mapped_column(Boolean, nullable=False, default=True)
    mirror_allowed: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False)
    prop_bearing: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False)
    inset_only: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False)
    created_at: Mapped[datetime] = mapped_column(DateTime(timezone=True), server_default=func.now(), nullable=False)


class OverlayRenderAttempt(Base):
    __tablename__ = "overlay_render_attempts"
    id: Mapped[str] = mapped_column(String(36), primary_key=True)
    scene_id: Mapped[str] = mapped_column(String(120), nullable=False)
    scene_order: Mapped[int] = mapped_column(Integer, nullable=False)
    scene_title: Mapped[str] = mapped_column(String(240), nullable=False)
    bible_set_id: Mapped[str] = mapped_column(ForeignKey("visual_bible_sets.id"), nullable=False)
    bible_set_version: Mapped[int] = mapped_column(Integer, nullable=False)
    package_id: Mapped[str] = mapped_column(ForeignKey("visual_prompt_packages.id"), nullable=False)
    package_hash: Mapped[str] = mapped_column(String(64), nullable=False)
    mascot_asset_id: Mapped[str] = mapped_column(ForeignKey("mascot_assets.id"), nullable=False)
    mascot_asset_sha256: Mapped[str] = mapped_column(String(64), nullable=False)
    source_relative_path: Mapped[str] = mapped_column(Text, nullable=False)
    ffmpeg_version: Mapped[str] = mapped_column(Text, nullable=False)
    filter_graph: Mapped[str] = mapped_column(Text, nullable=False)
    scale_width: Mapped[int] = mapped_column(Integer, nullable=False)
    scale_height: Mapped[int] = mapped_column(Integer, nullable=False)
    x_final: Mapped[int] = mapped_column(Integer, nullable=False)
    y_final: Mapped[int] = mapped_column(Integer, nullable=False)
    outer_margin_px: Mapped[int] = mapped_column(Integer, nullable=False)
    subtitle_safe_bottom_px: Mapped[int] = mapped_column(Integer, nullable=False)
    ...
    output_sha256: Mapped[str] = mapped_column(String(64), nullable=False)
    latency_ms: Mapped[int] = mapped_column(Integer, nullable=False)
    cpu_only: Mapped[bool] = mapped_column(Boolean, nullable=False)
    governance_status: Mapped[str] = mapped_column(String(16), nullable=False, default="DRAFT")
    human_review_status: Mapped[str] = mapped_column(String(24), nullable=False, default="PENDING")
    technical_status: Mapped[str] = mapped_column(String(24), nullable=False)
    static_visual_review: Mapped[str] = mapped_column(String(24), nullable=False, default="PENDING")
    motion_visual_review: Mapped[str] = mapped_column(String(24), nullable=False, default="PENDING")
    overlay_smoke_status: Mapped[str] = mapped_column(String(24), nullable=False, default="PENDING")
